...
- **ジャンプ**: Space / ↑ / クリック / タップ
- **長押しで高く跳ぶ**（本家準拠）。離すと上昇が打ち切られるので、小サボテンはチョン押し、大サボテンや3連は長押し
- サボテンを飛び越え、低い鳥は飛び越え、高い鳥はくぐる（ジャンプすると当たる）
- 本家準拠の等加速度で徐々に速くなる（開始 1.29 → 最高 2.8、本家と同じ 13/6 の比で約117秒）
  - スコアに応じて大サボテン(125) → 2連サボテン(330) → 鳥(450) → 3連サボテン(800) が解禁される
  - 鳥は本家同様、半分は地面より速く、半分は遅く飛ぶ
  - 障害物の間隔は本家準拠で「その障害物自身の幅 × 速度 + 定数」を 1.0〜1.5 倍したもの。幅の広い敵の後ほど長く空き、速度が上がるほどフレーム換算では詰まる（到達間隔は最短 38 → 28 フレーム、本家は 35 → 25）
  - 同じ種類が3連続では出ない（本家の MAX_OBSTACLE_DUPLICATION 準拠）
  - 最高速に達したあとは本家同様ほぼ据え置きで、スコア 2500 に向けて間隔のばらつきだけが狭まり、難しい敵の比率が上がる
