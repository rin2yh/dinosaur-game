...
- 本家準拠の等加速度で徐々に速くなり（約150秒で最高速）、スコア 2500 まで難易度が上がり続ける
  - スコアに応じて大サボテン(125) → 2連サボテン(330) → 鳥(450) → 3連サボテン(800) が解禁される
  - 鳥は本家同様、半分は地面より速く、半分は遅く飛ぶ
  - 障害物の間隔は本家準拠で「その障害物自身の幅 × 速度 + 定数」を 1.0〜1.5 倍したもの。幅の広い敵の後ほど長く空き、速度が上がるほどフレーム換算では詰まる
  - 同じ種類が3連続では出ない（本家の MAX_OBSTACLE_DUPLICATION 準拠）
  - 最高速に達したあとも、間隔が詰まり、難しい敵ほど出やすくなる
